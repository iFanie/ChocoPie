...
public abstract class ReparativeFragment<F> extends LoaderFragment implements ReparativeDelegates<F> {
    ...
    @Nullable
    private F getRestoredInstance(@Nullable ReparativeDelegates.Container readOnlyContainer) {
        ...
        F restoredInstance = null;

        try {
            restoredInstance = (F) this.getClass().newInstance();
    ...
    private void handleRestore(@Nullable Bundle bundle) {
        ...
        F restoredInstance = getRestoredInstance(container);
